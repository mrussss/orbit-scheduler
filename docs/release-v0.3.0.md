...
- PostgreSQL/Testcontainers integration, including Agent Trace monotonicity, tool-step crash/lease recovery, stale fencing, and 429 → Attempt 2, passed in 32.920 seconds;
...
- the complete MySQL Lab passed in 194.316 seconds and its three-round concurrency gate passed in 224.961 seconds;
- the Python baseline's Pydantic, async tools, native-SDK-shape loop, bounded-result summary, and shared ten-case eval tests passed in a clean Python 3.12 container: 5 tests in 0.49 seconds.
